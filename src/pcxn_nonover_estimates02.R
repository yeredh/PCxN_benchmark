...
# RUN ON ODYSSEY (pcxn_nonover_estimates02.sh) [1-1000]
...
# save results
saveRDS(resMnPn,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Pearson/GSE/RandomGS",args,"_nonover.RDS"))
rm(resMnPn)
...
# save results
saveRDS(resMnSp,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Spearman/GSE/RandomGS",args,"_nonover.RDS"))
rm(resMnSp)
...
# save results
saveRDS(resMdPn,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Pearson/GSE/RandomGS",args,"_nonover.RDS"))
...
# save results
saveRDS(resMdSp,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Spearman/GSE/RandomGS",args,"_nonover.RDS"))
