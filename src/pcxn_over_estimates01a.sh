...
R CMD BATCH "--args ${OVER} ${SLURM_ARRAY_TASK_ID}" /net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/src/pcxn_over_estimates01.R /net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/log/pcxn_over_"${OVER}"_estimates_"${SLURM_ARRAY_TASK_ID}".Rout
