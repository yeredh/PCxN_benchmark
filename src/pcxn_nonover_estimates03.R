...
# of the Ribosome pathway gene sets using the shrinkage
...
# ribosome pathway into non overlapping gene sets.
#
# The job array index is used to select the GSE series
# RUN ON ODYSSEY 
# (pcxn_nonover_estimates03.sh) [1-863]
...
GetCorEstimates = function(x,y,METHOD = "pearson"){
...
gs_lst = readRDS(paste0(pcxn_dir,"output/Benchmark/ribosome_non_over_gs.RDS"))
...
# save results
saveRDS(resMnPn,
        paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Pearson/GSE/",gse,"_ribosome_shrk_nonover.RDS")
)
...
# save results
saveRDS(resMnSp,
        paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Spearman/GSE/",gse,"_ribosome_shrk_nonover.RDS")
)
rm(resMnSp)
...
# save results
saveRDS(resMdPn,
        paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Pearson/GSE/",gse,"_ribosome_shrk_nonover.RDS")
)
...
# save results
saveRDS(resMdSp,
        paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Spearman/GSE/",gse,"_ribosome_shrk_nonover.RDS")
)
