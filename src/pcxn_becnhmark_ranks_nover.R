...
# ==== Ribosome (No overlap) =====
# Mean/Pearson
ribMnPn = readRDS("Hide Lab/PCxN/output/Benchmark/RibosomeNoOverMnPnShrk.RDS")
# Mean/Spearman
ribMnSp = readRDS("Hide Lab/PCxN/output/Benchmark/RibosomeNoOverMnSpShrk.RDS")
# Median/Pearson
ribMdPn = readRDS("Hide Lab/PCxN/output/Benchmark/RibosomeNoOverMdPnShrk.RDS")
# Median/Spearman
ribMdSp = readRDS("Hide Lab/PCxN/output/Benchmark/RibosomeNoOverMdSpShrk.RDS")

# ==== Random (No overlap) ====
# Mean/Pearson
rndMnPn = readRDS("Hide Lab/PCxN/output/Benchmark/RandomGSNoOverMnPnShrk.RDS")
# Mean/Spearman
rndMnSp = readRDS("Hide Lab/PCxN/output/Benchmark/RandomGSNoOverMnSpShrk.RDS")
# Median/Pearson
rndMdPn = readRDS("Hide Lab/PCxN/output/Benchmark/RandomGSNoOverMdPnShrk.RDS")
# Median/Spearman
rndMdSp = readRDS("Hide Lab/PCxN/output/Benchmark/RandomGSNoOverMdSpShrk.RDS")

library(rafalib)
# ==== Boxplots Correlation (No overlap) =====
mypar(1,1)
png("Hide Lab/PCxN/doc/Benchmark/figures/rib_v_rnd_nonover_shrk_cor_boxplots.png",
...
title("Correlation Estimates (No Overlap)",line=2)
abline(h=0,col="red")
...
# ROC curves
png("Hide Lab/PCxN/doc/Benchmark/figures/roc_liptak_nonover.png",
    width=800,height=450,pointsize = 15)
mypar(2,2)
...
# ROC curves
png("Hide Lab/PCxN/doc/Benchmark/figures/roc_logit_nonover.png",
    width=800,height=450,pointsize = 15)
mypar(2,2)
...
saveRDS(scoreBoard,"Hide Lab/PCxN/output/pcxn_benchmark_ranks_nover.RDS")