...
# RUN ON ODYSSEY (pcxn_nonover_mean_spearman01.sh) [1-863]
...
ProcessElement = function(ic){
  ...
  tmp = c(tmp,GetCorEstimates(x=summaryAu,y=summaryBu,METHOD = "spearman"))
...
# save results
saveRDS(res,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Spearman/GSE/",gse,"_ribosome_nonover.RDS"))
rm(list=ls())
