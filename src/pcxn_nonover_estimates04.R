# 03/19/2016
#
# Get experiment-level estimates for the No Overlap cases
# of the random gene sets using the shrinkage estimator for
# the correlation.
#
# The experiments are identified by its GSE id,
# and we get the estimates for every random split of the 
# ribosome pathway into non overlapping gene sets included in the benchmark
#
# The job array index is used to select the random gene sets with the script
# RUN ON ODYSSEY 
# (pcxn_nonover_estimates04.sh) [1-1000]
...
# ==== Ribosome Non Overlap Cases ====
gs_lst = readRDS(paste0(pcxn_dir,"output/Benchmark/random_non_over_gs.RDS"))
...
# save results
saveRDS(resMnPn,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Pearson/GSE/RandomGS",args,"_shrk_nonover.RDS"))
rm(resMnPn)
...
# save results
saveRDS(resMnSp,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Mean/Spearman/GSE/RandomGS",args,"_shrk_nonover.RDS"))
rm(resMnSp)
...
# save results
saveRDS(resMdPn,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Pearson/GSE/RandomGS",args,"_shrk_nonover.RDS"))
...
# save results
saveRDS(resMdSp,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Spearman/GSE/RandomGS",args,"_shrk_nonover.RDS"))
