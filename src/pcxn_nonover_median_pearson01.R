...
# RUN ON ODYSSEY (pcxn_nonover_median_pearson01.sh) [1-863]
...
# save results
saveRDS(res,paste0(pcxn_dir,"output/Benchmark/NoOverlap/Median/Pearson/GSE/",gse,"_ribosome_nonover.RDS"))
rm(list=ls())
