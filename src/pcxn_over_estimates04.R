...
# RUN ON ODYSSEY
#
# (pcxn_over_estimates04.sh) [1-1000]
# (pcxn_over_estimates04_shell.sh)
...
# save results
saveRDS(resMnPn,paste0(pcxn_dir,"output/Benchmark/Overlap/Mean/Pearson/Case",args[1],"/GSE/RandomGS",args[2],"_shrk_over",args[1],".RDS"))
rm(resMnPn)
...
# save results
saveRDS(resMnSp,paste0(pcxn_dir,"output/Benchmark/Overlap/Mean/Spearman/Case",args[1],"/GSE/RandomGS",args[2],"_shrk_over",args[1],".RDS"))
rm(resMnSp)
...
# save results
saveRDS(resMdPn,paste0(pcxn_dir,"output/Benchmark/Overlap/Median/Pearson/Case",args[1],"/GSE/RandomGS",args[2],"_shrk_over",args[1],".RDS"))
rm(resMdPn)
...
# save results
saveRDS(resMdSp,paste0(pcxn_dir,"output/Benchmark/Overlap/Median/Spearman/Case",args[1],"/GSE/RandomGS",args[2],"_shrk_over",args[1],".RDS"))
