...
R CMD BATCH "--args ${OVER} ${SLURM_ARRAY_TASK_ID}" /net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/src/pcxn_over_estimates04.R /net/hsphfs1/srv/export/hsphfs1/share_root/hide_lab/PCxN/log/pcxn_over_"${OVER}"_shrk_estimates_rnd_"${SLURM_ARRAY_TASK_ID}".Rout
